...
Docs are a **first-class deliverable of every phase** (see root `CLAUDE.md`).

- [`architecture/`](./architecture) — system + software/code architecture (Mermaid).
- [`adr/`](./adr) — Architecture Decision Records, one per significant choice.
