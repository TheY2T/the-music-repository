...
import { type BackgroundStyle, DEFAULT_PREF, getBackgroundPref } from '@/lib/dashboard-background';
...
const LOADERS: Record<Exclude<BackgroundStyle, 'none'>, () => Promise<{ default: never }>> = {
  staff: () => import('@/lib/pixi/bg-staff-scene') as Promise<{ default: never }>,
  waves: () => import('@/lib/pixi/bg-waves-scene') as Promise<{ default: never }>,
  roll: () => import('@/lib/pixi/bg-roll-scene') as Promise<{ default: never }>,
  bokeh: () => import('@/lib/pixi/ambient-scene') as Promise<{ default: never }>,
};
