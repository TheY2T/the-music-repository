...
export const CONTENT: SeedContent[] = [
  ...
  {
    slug: 'blues-shuffle-in-e',
    title: 'Blues Shuffle in E',
    summary: 'A 12-bar boogie shuffle riff in E — the backbone of electric blues rhythm guitar.',
    type: 'score',
    difficulty: 3,
    genres: ['blues'],
    instruments: ['guitar'],
    topics: ['rhythm', 'technique'],
    tags: ['cc-by-sa', 'beginner'],
    source: 'The Music Repository',
    attribution: 'The Music Repository',
    license: CC,
  },
  {
    slug: 'rock-power-chord-riff',
    title: 'Power-Chord Rock Riff',
    summary: 'A driving i–VI–VII power-chord riff in A minor for building rock rhythm technique.',
    type: 'score',
    difficulty: 2,
    genres: ['rock'],
    instruments: ['guitar'],
    topics: ['chords', 'technique'],
    tags: ['cc-by-sa', 'beginner'],
    source: 'The Music Repository',
    attribution: 'The Music Repository',
    license: CC,
  ...
  {
    slug: 'metal-gallop-riff',
    title: 'Palm-Mute Gallop (Metal Étude)',
    summary:
      'A galloping palm-muted pedal-tone riff in E with power-chord stabs — metal rhythm fundamentals.',
    type: 'score',
    difficulty: 4,
    genres: ['rock'],
    instruments: ['guitar'],
    topics: ['rhythm', 'technique'],
    tags: ['cc-by-sa', 'intermediate'],
    source: 'The Music Repository',
    attribution: 'The Music Repository',
    license: CC,
  },
  {
    slug: 'jazz-ii-v-i-comping',
    title: 'ii–V–I Comping Study in C',
    summary: 'Four-note jazz guitar voicings comping through a ii–V–I with a turnaround.',
    type: 'score',
    difficulty: 5,
    genres: ['jazz'],
    instruments: ['guitar'],
    topics: ['chords', 'voice-leading'],
    tags: ['cc-by-sa', 'intermediate'],
    source: 'The Music Repository',
    attribution: 'The Music Repository',
    license: CC,
  ...
  {
    slug: 'folk-travis-picking-study',
    title: 'Travis-Picking Study in G',
    summary:
      'An alternating-bass fingerpicking study in G — the Travis pattern that drives folk and country guitar.',
    type: 'score',
    difficulty: 4,
    genres: ['folk'],
    instruments: ['guitar'],
    topics: ['technique', 'arpeggios'],
    tags: ['cc-by-sa', 'americana', 'intermediate'],
    source: 'The Music Repository',
    attribution: 'The Music Repository',
    license: CC,
  },
  {
    slug: 'classical-arpeggio-study-am',
    title: 'Arpeggio Study in A minor',
    summary: 'A flowing right-hand arpeggio study in A minor in the manner of Sor and Carcassi.',
    type: 'score',
    difficulty: 3,
    genres: ['classical'],
    instruments: ['guitar'],
  ...
  {
    slug: 'renaissance-pavane',
    title: 'Pavane (Renaissance Style)',
    summary: 'A stately two-voice pavane in D minor evoking the Renaissance lute repertoire.',
    type: 'score',
    difficulty: 3,
    genres: ['classical'],
    instruments: ['guitar'],
  ...
  {
    slug: 'spanish-andalusian-study',
    title: 'Andalusian Study (Spanish Style)',
    summary:
      'An arpeggiated study over the Andalusian cadence (Am–G–F–E) with a Phrygian, flamenco colour.',
    type: 'score',
    difficulty: 4,
    genres: ['classical'],
    instruments: ['guitar'],
  ...
  {
    slug: 'ode-to-joy-for-guitar',
    title: 'Ode to Joy (Guitar Arrangement)',
    summary: "Beethoven's beloved melody arranged as a first single-line piece for guitar.",
    type: 'score',
    difficulty: 1,
    genres: ['classical'],
    instruments: ['guitar'],
  ...
  {
    slug: 'guitar-chord-library',
    title: 'The Essential Guitar Chords',
    summary: 'Open chords, barre shapes and the CAGED voicings every guitarist needs — with finger-by-finger diagrams.',
    type: 'lesson',
    difficulty: 2,
  ...
  },
  {
    ...
    title: 'Piano Chord Voicings & Inversions',
    summary: 'Root position, inversions and drop/shell voicings — how the same chord takes many shapes at the keyboard.',
    type: 'lesson',
    difficulty: 3,
    genres: ['jazz', 'pop'],
    instruments: ['piano'],
    topics: ['chords', 'harmony'],
    tags: ['intermediate'],
    source: 'Original',
    attribution: 'The Music Repository',
    license: 'CC BY-SA 4.0',
