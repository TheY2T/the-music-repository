...
export const SEED_COLLECTIONS: SeedCollectionDoc[] = [
        ...
        "items": [
          {
            ...
            "curatorNote": "Detached left hand, singing right — the Baroque default touch. skills: [articulation]",
            "focusSkills": [
              "articulation"
            ]
          }
        ...
        "items": [
          {
            ...
            "curatorNote": "Keep the broken-chord figuration perfectly even. skills: [evenness, voicing]",
            "focusSkills": [
              "evenness",
              "voicing"
            ]
        ...
        "items": [
          {
            ...
            "curatorNote": "Practise each hand alone until the subject is memorised. skills: [counterpoint, hand-independence]",
            "focusSkills": [
              "counterpoint",
              "hand-independence"
            ]
  ...
  },
  {
    ...
    "bodyMdx": "No one wrote for the piano like Chopin. Every piece is a study in singing tone, flexible rubato, and\nharmonic colour. This spotlight gathers his most approachable works, ordered from gentlest to grandest.",
    "curatorName": "The Music Repository",
        ...
        "items": [
          {
            ...
            "curatorNote": "The archetypal nocturne — melody floating over a rocking bass. skills: [rubato, pedaling]",
            "focusSkills": [
              "rubato",
              "pedaling"
            ]
  ...
  },
  {
    ...
    "bodyMdx": "Where do you go after your first pieces? This ladder lays out a long-term route through the piano\nrepertoire, one rung at a time — from beginner tunes to advanced Romantic writing — so you always know\nwhat to reach for next.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "bodyMdx": "Sonatinas are how generations of pianists learned Classical style — clean articulation, balanced phrases,\nand the architecture of sonata form in miniature. This graded set builds from Clementi to Mozart.",
    "curatorName": "The Music Repository",
        ...
        "items": [
          {
            ...
            "curatorNote": "\"Sonata facile\" — famously not so easy. Aim for evenness. skills: [scales, phrasing]",
            "focusSkills": [
              "scales",
              "phrasing"
            ]
  ...
  },
  {
    ...
    "bodyMdx": "Solo fingerstyle guitar rests on a handful of classic studies. This path builds right-hand control from\nCarulli and Sor through to the singing melodies of Tárrega — the foundation of the classical repertoire.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "bodyMdx": "Everyone starts somewhere. This path builds the right-hand control and reading you need through short,\nfriendly studies, then rewards you with a well-loved tune to play all the way through.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "bodyMdx": "Impressionist piano is about sound as colour. Here the pedal is a paintbrush and balance is everything.\nStart with Satie's stillness, then move into Debussy's shimmering layers of resonance.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "contentSlug": "debussy-clair-de-lune",
            "curatorNote": "The classic — voice the melody above a soft, pedalled wash. skills: [voicing, pedaling]",
            "focusSkills": [
              "voicing",
              "pedaling"
            ]
  ...
  {
    "slug": "jazz-and-blues-harmony",
    "title": "Jazz & Blues Harmony",
    "kind": "course",
    "summary": "Seventh chords, secondary dominants and the moves that make jazz and blues sing.",
    "bodyMdx": "Triads get you started; seventh chords and the moves between them are where jazz, blues and ragtime get\ntheir flavour. This course builds that harmonic vocabulary and shows it at work in real repertoire. Try\neach idea by ear with the [voice-leading viewer](/tools/voice-leading) and the\n[chord analyzer](/tools/analyzer).",
    "curatorName": "The Music Repository",
    "curatorBio": "Harmony beyond triads — the vocabulary of jazz, blues and ragtime.",
    "featured": false,
    "difficultyMin": 3,
    "difficultyMax": 8,
    "estMinutes": 240,
    ...
    "outcomes": [
      "Spell and hear seventh chords of every quality",
      "Use secondary dominants and borrowed chords",
      "Recognise these moves in ragtime and blues"
    ],
    "sections": [
      {
        "title": "Seventh-chord vocabulary",
        "description": null,
        "items": [
          {
            "contentSlug": "omt-diatonic-chords",
            "curatorNote": "The chords a key gives you — the starting palette.",
            "focusSkills": []
          },
          {
            "contentSlug": "omt-seventh-chords",
            "curatorNote": "Add the 7th and every chord gets richer. skills: [analysis]",
            "focusSkills": [
              "analysis"
            ]
          }
      ...
      {
        "title": "Making harmony move",
        "description": null,
        "items": [
          {
            "contentSlug": "omt-secondary-dominants",
            "curatorNote": "Borrow a dominant to pull toward any chord. skills: [analysis]",
            "focusSkills": [
              "analysis"
            ]
          },
          {
            ...
            "curatorNote": "Connect those chords smoothly.",
            "focusSkills": []
          },
          {
            "contentSlug": "omt-advanced-harmony-institution",
            "curatorNote": "Modal interchange and chromatic colour.",
            "focusSkills": []
          }
        ]
      },
      {
        "title": "Hear it in the repertoire",
        "description": null,
        "items": [
          {
            "contentSlug": "12-bar-blues-in-a",
            "curatorNote": "The blues form, harmonically.",
            "focusSkills": []
          },
          {
          ...
          },
          {
            ...
            "curatorNote": "Ragtime leans on secondary dominants — listen for the pull.",
            "focusSkills": []
          },
          {
  ...
  },
  {
    ...
    "bodyMdx": "Theory makes everything else easier — you stop memorising and start understanding. This syllabus builds\nin order: the raw materials (intervals, scales, rhythm), then how chords are built, then how they move.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
        ...
        "items": [
          {
            ...
            "curatorNote": "Everything in harmony is measured in intervals — start here. skills: [ear-training]",
            "focusSkills": [
              "ear-training"
            ]
          },
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "contentSlug": "omt-voice-leading",
            "curatorNote": "Smooth voice leading is what makes progressions sound good. skills: [analysis]",
            "focusSkills": [
              "analysis"
            ]
          }
  ...
  },
  {
    ...
    "bodyMdx": "Before the great repertoire comes the groundwork: even scales, independent fingers, and a first taste of\nreal pieces. This course pairs the essential drills with the tunes that put them to use.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "bodyMdx": "Folk songs are where music lives in everyday life. These public-domain melodies are simple to learn,\nendlessly arrangeable, and instantly recognisable — perfect for playing, singing, and sharing.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "bodyMdx": "Ragtime pairs a steady march-like left hand with a syncopated right — the sound that became jazz. This\nanthology starts with the gentler rags and works up to the classics, all drawn from the public domain.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
        ...
        "items": [
          {
            ...
            "curatorNote": "A slow \"Mexican serenade\" — start here for the feel. skills: [syncopation]",
            "focusSkills": [
              "syncopation"
            ]
          },
      ...
      },
      {
        ...
        "items": [
          {
            "contentSlug": "joplin-maple-leaf-rag",
            "curatorNote": "The rag that started it all — take the bass slowly. skills: [stride, articulation]",
            "focusSkills": [
              "stride",
              "articulation"
            ]
  ...
  },
  {
    ...
    "title": "Rhythm & Groove",
    "kind": "path",
    "summary": "Lock in time and feel — meter, walking bass lines and strumming grooves.",
    "bodyMdx": "Notes get the attention, but rhythm is what makes people move. This path builds your internal clock, then\nputs it to work laying down bass lines and strumming grooves. Drill the timing with the\n[metronome](/tools/metronome) and the [rhythm tap game](/tools/rhythm-game) as you go.",
    "curatorName": "The Music Repository",
    "curatorBio": "A path for the thing that makes music move: rhythm.",
    "featured": false,
    "difficultyMin": 1,
    "difficultyMax": 5,
    "estMinutes": 150,
    ...
    "outcomes": [
      "Read and feel note values and meter",
      "Play steady root-and-fifth and walking bass lines",
      "Keep a consistent strumming groove"
    ],
    "sections": [
      {
        "title": "Feel the beat",
        ...
        "items": [
          {
            "contentSlug": "omt-rhythm-and-meter",
            "curatorNote": "How rhythm is written and counted. skills: [rhythm]",
            "focusSkills": [
              "rhythm"
            ]
          }
      ...
      {
        "title": "Lay down a bass line",
        "description": null,
        "items": [
          {
            "contentSlug": "bass-root-fifth-patterns",
            "curatorNote": "The simplest solid bass — root and fifth.",
            "focusSkills": []
          },
          {
            "contentSlug": "walking-bass-basics",
            "curatorNote": "Make the bass line walk.",
            "focusSkills": []
          },
          {
            "contentSlug": "bass-blues-line-basics",
            "curatorNote": "A bass line built for the blues.",
            "focusSkills": []
          }
        ]
      },
      {
        "title": "Strum and comp",
        "description": null,
        "items": [
          {
            "contentSlug": "ukulele-strumming-patterns",
            "curatorNote": "Common patterns to keep steady time.",
            "focusSkills": []
          },
          {
            "contentSlug": "ukulele-fingerpicking-primer",
            "curatorNote": "A gentler groove for the fingers.",
            "focusSkills": []
          }
        ]
      }
  ...
  },
  {
    ...
    "bodyMdx": "The Romantic miniature is where you learn to sing at the piano — to shape a melody, breathe with rubato,\nand colour the sound with the pedal. These short character pieces reward patience and a good ear.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "contentSlug": "chopin-nocturne-op9-no2",
            "curatorNote": "The nocturne touch: melody floating over a rocking bass. skills: [rubato, voicing]",
            "focusSkills": [
              "rubato",
              "voicing"
            ]
  ...
  },
  {
    ...
    "bodyMdx": "Technique is freedom: the more automatic your scales and arpeggios, the more attention you have for\nmusic. Rotate through this workout daily — a few minutes on each — and keep everything even and relaxed.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
      {
        ...
        "items": [
          {
            "contentSlug": "c-major-scale-two-octaves",
            "curatorNote": "The reference scale — perfect the thumb-under here first. skills: [evenness]",
            "focusSkills": [
              "evenness"
            ]
          },
      ...
      },
      {
        ...
        "items": [
          {
            "contentSlug": "hanon-virtuoso-pianist-no-1",
            "curatorNote": "Slow, loud, and relaxed builds the most strength. skills: [finger-independence]",
            "focusSkills": [
              "finger-independence"
            ]
          }
  ...
  },
  {
    ...
    "bodyMdx": "The blues is a feel and a form. This path starts with the 12-bar structure, adds the scale that makes\nit sing, then puts it all together with a left-hand bass line and a classic blues standard to play.",
    "curatorName": "The Music Repository",
    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          {
            "contentSlug": "walking-bass-basics",
            "curatorNote": "A steady quarter-note bass turns changes into groove. skills: [walking-bass]",
            "focusSkills": [
              "walking-bass"
            ]
          },
  ...
  {
    "slug": "the-improvisers-toolkit",
    "title": "The Improviser's Toolkit",
    "kind": "path",
    "summary": "The scales, chords and tunes to start soloing — from the pentatonic to blues changes.",
    "bodyMdx": "Improvising isn't magic — it's a small kit of scales and chord shapes you learn to hear and reach for.\nThis path builds that kit, then puts it straight over real tunes. Keep the\n[Improvise guide](/tools/improvise) open alongside it to see which scales fit each chord, and jam over\nthe changes with the [progression generator](/tools/progression-generator).",
    "curatorName": "The Music Repository",
    "curatorBio": "A practical path from your first scale shapes to soloing over a 12-bar blues.",
    "featured": false,
    "difficultyMin": 2,
    "difficultyMax": 6,
    "estMinutes": 180,
    ...
    "outcomes": [
      "Play the minor pentatonic and blues scales in a usable position",
      "Understand the chords a solo is moving over",
      "Solo over a 12-bar blues with confidence"
    ],
    "sections": [
      {
        "title": "The scales you'll reach for",
        "description": null,
        "items": [
          {
            "contentSlug": "minor-pentatonic-scale-shapes",
            "curatorNote": "The five-note scale behind most rock and blues solos. skills: [scales]",
            "focusSkills": [
              "scales"
            ]
          },
          {
            "contentSlug": "blues-scale-piano",
            "curatorNote": "Add the \"blue note\" and you have the blues scale.",
            "focusSkills": []
          },
          {
            "contentSlug": "omt-modes-of-major",
            "curatorNote": "When you want more colours than the pentatonic. skills: [analysis]",
            "focusSkills": [
              "analysis"
            ]
          }
      ...
      {
        "title": "The chords underneath",
        "description": null,
        "items": [
          {
            "contentSlug": "omt-seventh-chords",
            "curatorNote": "Blues and jazz live on seventh chords — know what you're blowing over.",
            "focusSkills": []
          },
          {
            "contentSlug": "12-bar-blues-in-a",
            "curatorNote": "The form you'll solo over most.",
            "focusSkills": []
          }
        ]
      },
      {
        "title": "Put it over a tune",
        "description": null,
        "items": [
          {
            "contentSlug": "handy-st-louis-blues",
            "curatorNote": "A classic to trade solos on.",
            "focusSkills": []
          },
          {
            "contentSlug": "frankie-and-johnny",
            "curatorNote": "A 12-bar blues ballad — swap the melody for a solo.",
            "focusSkills": []
          }
        ]
      }
  ...
  },
  {
    ...
    "bodyMdx": "The ukulele is the friendliest instrument to start on — four strings, soft nylon, and songs within reach\nin an afternoon. This path takes you from your first chords to strumming and picking real tunes.",
    "curatorName": "The Music Repository",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "description": "Pieces that ask the hands to cooperate — the real beginning of piano playing.",
        "items": [
          {
