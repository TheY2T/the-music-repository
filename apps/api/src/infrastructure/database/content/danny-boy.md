...
suggestedDifficulty: keep
suggestedTags: [public-domain, folk, irish, ballad]
relatedSlugs: [shenandoah, amazing-grace-trad, aloha-oe-ukulele]
sources: [https://en.wikipedia.org/wiki/Danny_Boy, https://en.wikipedia.org/wiki/Londonderry_Air]
---
## About this song
...
```embeds
[{ "tool": "keyboard", "title": "The notes of E♭ major", "caption": "The key the melody lives in — click through the E♭ major scale to hear its colour.", "root": "Eb", "scale": "major", "size": 49 }]
```
