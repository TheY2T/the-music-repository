...
// Chord-diagram DATA lives in @TheY2T/tmr-music-core; the SVG renderer in ./organisms. Re-exported
// here so the tools importing ChordDiagrams keep one import surface. Audio (`strumChord`) lives here
// because sound generation is an app/runtime concern injected at the call site.
export {
  ChordDiagram,
  type ChordShape,
  GUITAR_CHORDS,
